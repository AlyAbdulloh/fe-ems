...
export class LeafletComponent implements OnInit {
   ...
   */
   options = {
    layers: [
      tileLayer(
        `https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=${environment.mapboxToken}`,
        {
          maxZoom: 18,
          attribution:
   ...
   */
   markers = {
    ...
    choropleth = {
      layers: [
        tileLayer(`https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=${environment.mapboxToken}`, {
          id: "mapbox/light-v9",
          tileSize: 512,
          zoomOffset: -1,
          maxZoom: 18,
